...
//units
 ...
 //    Route::post('/merchants/copyCars', 'AdminController@copyBranchCars')->name('copy_branch_cars')->middleware('add_car');
      ...
      Route::get('/add-agent', 'AdminController@addAgent');
      Route::post('/add-agent', 'AdminController@addNewAgent');
      Route::get('/edit-agent/{id}', 'AdminController@editAgent');
      Route::post('/update-agent', 'AdminController@updateAgent');
      Route::post('/delete-agent', 'AdminController@deleteAgent');
