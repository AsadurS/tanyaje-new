...
class Kernel extends HttpKernel
{
    ...
    protected $routeMiddleware = [
      ...
      'Customer' => \App\Http\Middleware\RedirectIfNotCustomer::class,
        ...
        'view_make' => \App\Http\Middleware\make\view_make::class,
        'edit_make' => \App\Http\Middleware\make\edit_make::class,
        'delete_make' => \App\Http\Middleware\make\delete_make::class,
        'add_make' => \App\Http\Middleware\make\add_make::class,
        'view_model' => \App\Http\Middleware\model\view_model::class,
        'edit_model' => \App\Http\Middleware\model\edit_model::class,
        'delete_model' => \App\Http\Middleware\model\delete_model::class,
        'add_model' => \App\Http\Middleware\model\add_model::class,
        ...
        'view_cities' => \App\Http\Middleware\cities\view_cities::class,
        'edit_cities' => \App\Http\Middleware\cities\edit_cities::class,
        'delete_cities' => \App\Http\Middleware\cities\delete_cities::class,
        'add_cities' => \App\Http\Middleware\cities\add_cities::class,
        'view_type' => \App\Http\Middleware\type\view_type::class,
        'edit_type' => \App\Http\Middleware\type\edit_type::class,
        'delete_type' => \App\Http\Middleware\type\delete_type::class,
        'add_type' => \App\Http\Middleware\type\add_type::class,
        'view_car' => \App\Http\Middleware\car\view_car::class,
        'edit_car' => \App\Http\Middleware\car\edit_car::class,
        'delete_car' => \App\Http\Middleware\car\delete_car::class,
        'add_car' => \App\Http\Middleware\car\add_car::class,
        'view_manage_merchant' => \App\Http\Middleware\manage_merchant\view_manage_merchant::class,
        'edit_manage_merchant' => \App\Http\Middleware\manage_merchant\edit_manage_merchant::class,
        'delete_manage_merchant' => \App\Http\Middleware\manage_merchant\delete_manage_merchant::class,
        'add_manage_merchant' => \App\Http\Middleware\manage_merchant\add_manage_merchant::class,
        ...
        'view_manage_manager' => \App\Http\Middleware\manage_manager\view_manage_manager::class,
        'edit_manage_manager' => \App\Http\Middleware\manage_manager\edit_manage_manager::class,
        'delete_manage_manager' => \App\Http\Middleware\manage_manager\delete_manage_manager::class,
        'add_manage_manager' => \App\Http\Middleware\manage_manager\add_manage_manager::class,
