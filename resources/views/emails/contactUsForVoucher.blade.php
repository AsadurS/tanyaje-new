	...
	<tr>
		<td>
			<table class="table-inner" align="center" width="600" style="max-width: 600px;" border="0" cellspacing="0" cellpadding="0">
				...
				<!-- title -->
				<tr>
					<td align="center" style="font-family: 'Open Sans', Arial, sans-serif; font-size:36px; color:#3b3b3b; font-weight: bold;width:100%;background-color:#ffffff;">Voucher Form Submission</td>
				</tr>
				<tr>
					<td align="center" style="background-color:#ffffff">
						<table style="width:15px;margin:0 auto;">
							<tr>
								<td height="25" style="border-bottom:2px solid #000;"></td>
							</tr>
						</table>
					</td>
				</tr>
				...
				<tr>
					<td align="center" bgcolor="#ffffff">
						<table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
							...
							<!-- content -->
							@if( isset($data['voucher_name']) )
								<tr>
									<td style="width:120px; font-family: 'Open Sans', Arial, sans-serif; font-size:14px; color:#7f8c8d; line-height:29px;">
										Voucher Name :
									</td>
									<td>
										{{ $data['voucher_name'] }}
							...
							@endif
							@if( isset($data['entry_street_address']) )
								<tr>
									<td style="width:120px; font-family: 'Open Sans', Arial, sans-serif; font-size:14px; color:#7f8c8d; line-height:29px;">
										Address :
									</td>
									<td>
										{{ $data['entry_street_address'] }}
									</td>
								</tr>
							@endif
							@if( isset($data['state']) )
