    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            @if($role->dashboard_view == 1)
                <div class="row">
                    @if( Auth()->user()->role_id == \App\Models\Core\User::ROLE_SUPER_ADMIN )
                        ...
                        <!-- ./col -->
                    @elseif( Auth()->user()->role_id == \App\Models\Core\User::ROLE_MERCHANT )
                        <div class="col-lg-4 col-xs-6">

                            <div class="small-box bg-teal">
                                <div class="inner">
                                    <h3>{{ $result['totalCarByMerchant'] }}</h3>
                                    <p>Total Car</p>
                                </div>
                                <div class="icon">
                                    <i class="ion ion-model-s"></i>
                                </div>
                                <a href="{{ URL::to('admin/car/display')}}" class="small-box-footer" data-toggle="tooltip" data-placement="bottom" title="View All Car">
                                    View All Car
                                    <i class="fa fa-arrow-circle-right"></i>
                                </a>
                            </div>
                        </div>
                    @elseif( Auth()->user()->role_id == \App\Models\Core\User::ROLE_NORMAL_ADMIN || Auth()->user()->role_id == \App\Models\Core\User::ROLE_MANAGER )
                        <div class="col-lg-4 col-xs-6">
                            <!-- small box -->
                            <div class="small-box bg-yellow">
                                <div class="inner">
                                    <h3>{{ $result['totalMake'] }}</h3>
                                ...
                                <a href="{{ URL::to('admin/make/display')}}" class="small-box-footer" data-toggle="tooltip" data-placement="bottom" title="View All Make">
                                    View All Make
                                    <i class="fa fa-arrow-circle-right"></i>
                                </a>
                            </div>
                        ...
                        <div class="col-lg-4 col-xs-6">
                            ...
                            <div class="small-box bg-aqua">
                                ...
                                <a href="{{ URL::to('admin/merchants')}}" class="small-box-footer" data-toggle="tooltip" data-placement="bottom" title="View All Merchat">
                                    View All Merchat
                                    <i class="fa fa-arrow-circle-right"></i>
                                </a>
                            </div>
