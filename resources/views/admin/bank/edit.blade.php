...
@section('content')
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1> {{ trans('labels.Bank') }}  <small>{{ trans('labels.EditCurrentBank') }}...</small> </h1>
            <ol class="breadcrumb">
                <li><a href="{{ URL::to('admin/dashboard/this_month') }}"><i class="fa fa-dashboard"></i> {{ trans('labels.breadcrumb_dashboard') }}</a></li>
                <li><a href="{{ URL::to('admin/banks')}}"><i class="fa fa-industry"></i> {{ trans('labels.Bank') }}</a></li>
                <li class="active">{{ trans('labels.EditBank') }}</li>
            </ol>
        </section>
                ...
                <div class="col-md-12">
                    <div class="box">
                        <div class="box-header">
                            <h3 class="box-title">{{ trans('labels.EditBankInfo') }} </h3>
                        </div>
                                ...
                                <div class="col-xs-12">
                                    ...
                                    <!-- /.box-header -->
                                        ...
                                        <div class="box-body">
                                            ...
                                            {!! Form::open(array('url' =>'admin/updateBanks', 'method'=>'post', 'class' => 'form-horizontal form-validate', 'enctype'=>'multipart/form-data')) !!}
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10 col-md-4">
                                                    {!! Form::text('bank_name', $result['admins'][0]->bank_name, array('class'=>'form-control  field-validate', 'id'=>'bank_name')) !!}
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10 col-md-4">
                                                    ...
                                                    <br>
                                                    <img src="{{asset('images/logo/'.$result['admins'][0]->logo)}}" alt="photo" style="width:50%;"/> -->
