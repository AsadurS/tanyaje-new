...
<div class="content-wrapper"> 
  ...
  <section class="content-header">
    <h1> Add Agent <small>Add Agent</small> </h1>
    <ol class="breadcrumb">
      <li><a href="{{ URL::to('admin/dashboard/this_month')}}"><i class="fa fa-dashboard"></i> {{ trans('labels.breadcrumb_dashboard') }}</a></li>
      <li><a href="{{ URL::to('admin/agents')}}"><i class="fa fa-users"></i> Agents</a></li>
            ...
            <div class="row">
              <div class="col-xs-12">
              		<div class="box box-info">
                        ...
                        <!-- form start -->                        
                         <div class="box-body">
                            {!! Form::open(array('url' =>'admin/add-agent', 'method'=>'post', 'class' => 'form-horizontal form-validate', 'enctype'=>'multipart/form-data')) !!}
