...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1> Edit Agent <small>Edit Agent...</small> </h1>
    <ol class="breadcrumb">
            ...
            <div class="row">
              <div class="col-xs-12">
              		<div class="box box-info">
                        ...
                        <!-- form start -->
                         <div class="box-body">
                            {!! Form::open(array('url' =>'admin/update-agent', 'method'=>'post', 'class' => 'form-horizontal form-validate', 'enctype'=>'multipart/form-data')) !!}
