              		...
              		<div class="box box-info">
                        ...
                        @endif
                           ...
                           <div class="row">
                            ...
                            <div class="col-md-6"
                                {{ Auth()->user()->role_id == \App\Models\Core\User::ROLE_NORMAL_ADMIN &&
                                 ( $datas['link_name'] == "manufacturer" || $datas['link_name'] == "categories" ||
                                   $datas['link_name'] == "products" || $datas['link_name'] == "customers" || $datas['link_name'] == "news" ||
                                   $datas['link_name'] == "tax_location" || $datas['link_name'] == "coupons" ||
                                   $datas['link_name'] == "notifications" || $datas['link_name'] == "orders" || $datas['link_name'] == "manage_types" ||
                                   $datas['link_name'] == "shipping_methods" || $datas['link_name'] == "payment_methods" || $datas['link_name'] == "reports" ||
                                   $datas['link_name'] == "application_setting" ||  $datas['link_name'] == "general_setting" ||
                                   $datas['link_name'] == "language" )? 'style=display:none': '' }}>
                            <hr>
