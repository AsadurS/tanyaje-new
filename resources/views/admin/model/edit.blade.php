...
@section('content')
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1> {{ trans('labels.Model') }}  <small>{{ trans('labels.EditCurrentModel') }}...</small> </h1>
            <ol class="breadcrumb">
                <li><a href="{{ URL::to('admin/dashboard/this_month') }}"><i class="fa fa-dashboard"></i> {{ trans('labels.breadcrumb_dashboard') }}</a></li>
                <li><a href="{{ URL::to('admin/model/display')}}"><i class="fa fa-database"></i> {{ trans('labels.Model') }}</a></li>
                <li class="active">{{ trans('labels.EditModel') }}</li>
            </ol>
        </section>
                ...
                <div class="col-md-12">
                    <div class="box">
                        <div class="box-header">
                            <h3 class="box-title">{{ trans('labels.EditModelInfo') }} </h3>
                        </div>
                                ...
                                <div class="col-xs-12">
                                    ...
                                    <!-- /.box-header -->
                                        ...
                                        <div class="box-body">
                                            ...
                                            {!! Form::open(array('url' =>'admin/model/update', 'method'=>'post', 'class' => 'form-horizontal form-validate', 'enctype'=>'multipart/form-data')) !!}
                                            {!! Form::hidden('id',  $editModel[0]->id , array('class'=>'form-control', 'id'=>'id')) !!}
                                                ...
                                                <div class="col-sm-10 col-md-4">
                                                    <select name="model_make_id" class='form-control field-validate select2'>
                                                        @foreach( $result['make'] as $make_data)
                                                            <option
                                                                    @if( $make_data->make_id == $editModel[0]->model_make_id)
                                                                    selected
                                                                    @endif
