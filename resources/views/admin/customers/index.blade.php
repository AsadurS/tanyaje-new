                            ...
                            <div class="col-xs-12">
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        @php
                                            $state = States::where('state_id',$listingCustomers->state_id)->first();
                                        @endphp
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <br>
                                                @if($state)
                                                    <strong>{{ trans('labels.State') }}: </strong>
                                                        {{$state->state_name}}
                                                        <br>
                                                @endif
                                                @if(!empty($listingCustomers->entry_postcode))
                                                    <strong>{{ trans('labels.Zip') }}: </strong>
                                            ...
                                            <td>
                                                <ul class="nav table-nav">
                                                    <li class="dropdown">
                                                        ...
                                                        <li role="presentation"><a role="menuitem" tabindex="-1" href="{{url('admin/customers/history') }}/{{$listingCustomers->id}}">Redemptions</a></li>
