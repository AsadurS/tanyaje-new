...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1> {{ trans('labels.linkSubItem') }} <small>{{ trans('labels.linkSubItem') }}...</small> </h1>
    <ol class="breadcrumb">
      <li><a href="{{ URL::to('admin/dashboard/this_month')}}"><i class="fa fa-dashboard"></i> {{ trans('labels.breadcrumb_dashboard') }}</a></li>
      <li class="active">{{ trans('labels.linkSubItem') }}</li>
    </ol>
  </section>
        ...
        <div class="box">
          <div class="box-header">
            ...
            <div class="container-fluid">
                <div class="row">
                <div class="col-xs-12">
                    {!! Form::open(array('url' =>'admin/filteritemreport', 'method'=>'get', 'class' => 'form-horizontal form-validate ', 'enctype'=>'multipart/form-data')) !!}
          ...
          <div class="box-body">
            ...
            <div class="row">
              <div class="col-xs-12">
                {!! Form::open(array('url' =>'admin/filteritemreport', 'method'=>'get', 'class' => 'search-filter form-horizontal', 'enctype'=>'multipart/form-data')) !!}
                <div class="form-group row">
                  <div class="col-xs-2">
                    <input class="form-control" id="filter_name" name="filter_name" type="text" placeholder="Item Name" value="{{ request()->has('filter_name') ? request()->get('filter_name') : '' }}">
                  </div>
                  <div class="col-xs-2">
                    <select id="organisation_id" name="organisation_id" class="form-control select2">
                        <option value="">Organisation Name</option>
                  ...
                  <div class="col-xs-4">
                      ...
                      <a href="{{ url('/admin/itemreport') }}" class="btn btn-primary"><span class="glyphicon glyphicon-remove" aria-hidden="true"></span></a>
                  </div>
                </div>
                {!! Form::close() !!}
              </div>
            ...
            <div class="row">
                ...
                <table id="organisation" class="table table-bordered table-striped">
                  <thead>
                    <tr>
                      <th style="width:25%;vertical-align: top;">{{ trans('labels.reportItem') }}</th>
...
var myChart = new Chart(ctx, {
    ...
    options:{
      plugins: {
          title: {
            display: true,
            text: ["Item's Pageview and Call Statistics", @json($result['chartsSubTitle']) ],
            font: {
              size: 14
            }
          },
