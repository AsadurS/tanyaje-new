                         ...
                         <div class="box-body">
                            ...
                            {!! Form::open(array('url' =>'admin/addNewSlide', 'method'=>'post', 'class' => 'form-horizontal form-validate', 'enctype'=>'multipart/form-data')) !!}
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10 col-md-4">
                                      {!! Form::text('sliders_url', '', array('class'=>'form-control field-validate','id'=>'sliders_url')) !!}
                                ...
                                <div class="form-group" id="imageIcone">
                                    ...
                                    <div class="col-sm-10 col-md-4">
                                        ...
                                        <div id="imageselected">
                                          {!! Form::button('Add Slide', array('id'=>'newIcon','class'=>"btn btn-primary field-validate", 'data-toggle'=>"modal", 'data-target'=>"#ModalmanufacturedICone" )) !!}
                                          <br>
                                        ...
                                        <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">Please choose the slide</span>
