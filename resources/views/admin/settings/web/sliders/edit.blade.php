                         ...
                         <div class="box-body">
                            ...
                            {!! Form::open(array('url' =>'admin/updateSlide', 'method'=>'post', 'class' => 'form-horizontal', 'enctype'=>'multipart/form-data')) !!}
                                ...
                                @if(Auth()->user()->role_id == \App\Models\Core\User::ROLE_MERCHANT)
                                    {!! Form::hidden('merchant_id', Auth::user()->id) !!}
                                @else
                                    <div class="form-group">
                                    <label for="name" class="col-sm-2 col-md-3 control-label">{{ trans('labels.Merchant') }}</label>
                                    <div class="col-sm-10 col-md-4">
                                        <select class="form-control" name="merchant_id">
                                            <option value="">Select Merchant</option>
                                            @foreach($result['merchants'] as $merchant)
                                                <option value="{{$merchant->id}}" @if($merchant->id==$result['sliders'][0]->merchant_id) selected @endif>{{ $merchant->company_name }}</option>
                                            @endforeach
                                        </select>
                                        <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10 col-md-4">
                                      {!! Form::text('sliders_url', $result['sliders'][0]->sliders_url, array('class'=>'form-control','id'=>'sliders_title')) !!}
                                      {{-- <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">{{ trans('labels.SliderURLtext') }}</span> --}}
                                    </div>
                                </div>
                                {{-- <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label for="name" class="col-sm-2 col-md-3 control-label">Slides</label>
                                    <div class="col-sm-10 col-md-4">
                                        ...
                                        <!-- Modal -->
                                            ...
                                            <div  id ="imageselected">
                                                {!! Form::button('Add Slide', array('id'=>'newImage','class'=>"btn btn-primary", 'data-toggle'=>"modal", 'data-target'=>"#Modalmanufactured" )) !!}
                                                <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 3px;">Please choose the slide</span>
                                                <div class="closimage">
                                                ...
                                                <br>
                                                {!! Form::hidden('oldImage', $result['sliders'][0]->path, array('id'=>'oldImage')) !!}
                                                @if(($result['sliders'][0]->path!== null))
                                                    <img width="80px" src="{{asset($result['sliders'][0]->path)}}" class="">
                                                @else
                                                    <img width="80px" src="{{asset($result['sliders'][0]->path) }}" class="">
                                                @endif
