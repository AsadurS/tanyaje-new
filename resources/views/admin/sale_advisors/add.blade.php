            ...
            <div class="row">
              <div class="col-xs-12">
              		<div class="box box-info">
                        ...
                        <!-- form start -->
                         <div class="box-body">
                            {!! Form::open(array('url' =>'admin/insertsaleadvisor', 'method'=>'post', 'class' => 'form-horizontal form-validate', 'enctype'=>'multipart/form-data')) !!}
                            @csrf
                            <!-- <input class="form-control" id="merchant_name" name="user_id" type="hidden" value=""> -->
                            <h4>{{ trans('labels.SaleAdvisorInfo') }}</h4>
                            <hr>
                            <div class="form-group">
                                <label for="profile_img" class="col-sm-2 col-md-2 control-label" style="">{{ trans('labels.UploadProfilePhoto') }}</label>
                                <div class="col-sm-10 col-md-3">
                                    <!-- <input type="file" name="profile_img" id="profile_img" class="form-control"> -->
                                    <span style="display:flex;">
                                      <input type="text" id="profile_img" class="form-control" name="profile_img" readonly="readonly" aria-label="Image" aria-describedby="button-image" value="">
                                ...
                                <div class="col-sm-10 col-md-3">
                                    <select name="organisation_id" id="organisation_id" class="form-control field-validate select2">
                                        <option>Organisations</option>
                                        @if (count($result['admins']) > 0)
                                            @foreach ($result['admins']  as $key=>$admin)
                                                @if ($result['user_id'])
                                                    <option value="{{ $admin->id }}" @if($admin->id == $result['user_id']) selected @endif>{{ $admin->company_name }}</option>
                                                @else
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10 col-md-3">
                                    <input type="text" name="merchant_emp_id" id="merchant_emp_id" class="form-control">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10 col-md-3">
                                    <input type="text" name="merchant_phone_no" id="merchant_phone_no" class="form-control field-validate" onInput="edValueKeyPress()">
                                    <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">{{ trans('labels.SaleAdvisorContactNoText') }}</span>
                                    <span class="help-block hidden">{{ trans('labels.textRequiredFieldMessage') }}</span>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="position" class="col-sm-2 col-md-2 control-label" style="">{{ trans('labels.SaleAdvisorPassword') }}</label>
                                <div class="col-sm-10 col-md-3">
                                ...
                                <div class="col-sm-10 col-md-3">
                                    ...
                                    <textarea name="address" id="address" class="form-control field-validate"></textarea>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10 col-md-3">
                                    <input type="text" name="merchant_postcode" id="merchant_postcode" class="form-control field-validate">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10 col-md-3" style="display:flex !important;">
                                    <select name="state_id" id="state_id" class="form-control field-validate select2" style="width:50% !important;margin: 0px 3px;">
                                        <option>State</option>
                                    ...
                                    <select name="city_id" id="city_id" class="form-control field-validate select2" style="width:50% !important;margin: 0px 3px;">
                                        <option>City</option>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10 col-md-3">
                                    <input class="form-control" name="whatsapp_url" id="lblValue" style="height: 60px;overflow: auto;" value="Link generated based on contact number" readonly>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <div class="col-md-5">
                                    <div class="form-group">
                                        <label for="generate_qr" class="col-sm-2 col-md-5 control-label" style="">{{ trans('labels.GenerateQRCode') }}</label>
                                        <div class="col-sm-10 col-md-6">
                                            <label class=" control-label">
                                                <input type="radio" name="generate_qr" value="1" class="flat-red" checked> &nbsp;{{ trans('labels.Yes') }}
                                            </label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    ...
                                    <div class="form-group">
                                        <label for="display_qr" class="col-sm-2 col-md-5 control-label" style="">{{ trans('labels.QRCode') }}</label>
                                        <div class="col-sm-10 col-md-6">
                                            <label class=" control-label">
                                                <input type="radio" name="display_qr" value="1" class="flat-red" checked> &nbsp;{{ trans('labels.Yes') }}
                                            </label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;

                                            <label class=" control-label">
                                                <input type="radio" name="display_qr" value="0" class="flat-red">  &nbsp;{{ trans('labels.No') }}
                                            </label>
                                    ...
                                    <div class="form-group">
                                        <label for="contactMe" class="col-sm-2 col-md-5 control-label" style="">{{ trans('labels.ContactMe') }}</label>
                                        <div class="col-sm-10 col-md-6">
                                            <label class=" control-label">
                                                <input type="radio" name="contactMe" value="1" class="flat-red" checked> &nbsp;{{ trans('labels.Yes') }}
                                            </label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    ...
                                    <div class="form-group">
                                        <label for="showMe" class="col-sm-2 col-md-5 control-label" style="">{{ trans('labels.ShowMe') }}</label>
                                        <div class="col-sm-10 col-md-6">
                                            <label class=" control-label">
                                                <input type="radio" name="showMe" value="1" class="flat-red" checked> &nbsp;{{ trans('labels.Yes') }}
                                            </label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    ...
                                    <div class="form-group">
                                        <label for="askMe" class="col-sm-2 col-md-5 control-label" style="">{{ trans('labels.AskMe') }}</label>
                                        <div class="col-sm-10 col-md-6">
                                            <label class=" control-label">
                                                <input type="radio" name="askMe" value="1" class="flat-red" checked> &nbsp;{{ trans('labels.Yes') }}
                                            </label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    ...
                                    <div class="form-group">
                                        <label for="keepMe" class="col-sm-2 col-md-5 control-label" style="">{{ trans('labels.KeepMe') }}</label>
                                        <div class="col-sm-10 col-md-6">
                                            <label class=" control-label">
                                                <input type="radio" name="keepMe" value="1" class="flat-red" checked> &nbsp;{{ trans('labels.Yes') }}
                                            </label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    ...
                                    <div class="form-group">
                                        <label for="campaign" class="col-sm-2 col-md-5 control-label" style="">{{ trans('labels.Campaigns') }}</label>
                                        <div class="col-sm-10 col-md-6">
                                            <label class=" control-label">
                                                <input type="radio" name="campaign" value="1" class="flat-red" checked> &nbsp;{{ trans('labels.Yes') }}
                                            </label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;

                                            <label class=" control-label">
                                                <input type="radio" name="campaign" value="0" class="flat-red">  &nbsp;{{ trans('labels.No') }}
                                            </label>
                                            <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">Choose option to display Campaigns or not.</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-7">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10 col-md-8">
                                            <textarea name="whatsappDefaultMessage" id="whatsappDefaultMessage" class="form-control">Hi {advisor name}, i’m interested to know more about your product listed in your Tanya-Je Digital MU. Please contact me.</textarea>
                                    ...
                                    <div class="form-group">
                                        <label for="name" class="col-sm-2 col-md-2 control-label" style="">{{ trans('labels.LandingPageVersion') }}</label>
                                        <div class="col-sm-10 col-md-8">
                                            <label class=" control-label">
                                                <input type="radio" name="landingpage_version" value="0" class="flat-red" checked> &nbsp;{{ trans('labels.StandardLandingPage') }}
                                            </label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;

                                            <label class=" control-label">
                                                <input type="radio" name="landingpage_version" value="1" class="flat-red">  &nbsp;{{ trans('labels.LiteLandingPage') }}
                                            </label>
                                    ...
                                    <div class="form-group">
                                        <label for="landingpage_images" class="col-sm-2 col-md-2 control-label" style="">{{ trans('labels.LandingPageImageLogo') }}</label>
                                        <div class="col-sm-10 col-md-8">
                                            <textarea name="landingpage_images" id="landingpage_images" class="landingpage_images form-control"></textarea>
...
<script type="text/javascript">
    var editor = CKEDITOR.replace( 'landingpage_images', {filebrowserImageBrowseUrl: '/file-manager/ckeditor', customConfig: '/js/ckeditor.config.js'} );
</script>
<script>
