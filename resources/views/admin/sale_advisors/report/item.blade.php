        ...
        <div class="box">
          <div class="box-header">
            ...
            <div class="container-fluid">
                <div class="row">
                <div class="col-xs-12">
                    {!! Form::open(array('url' =>'admin/sale_advisors/filteritemreport', 'method'=>'get', 'class' => 'form-horizontal form-validate ', 'enctype'=>'multipart/form-data')) !!}
          ...
          <div class="box-body">
            ...
            <div class="row">
              <div class="col-xs-12">
                {!! Form::open(array('url' =>'admin/sale_advisors/filteritemreport', 'method'=>'get', 'class' => 'search-filter form-horizontal', 'enctype'=>'multipart/form-data')) !!}
                <div class="form-group row">
                  <div class="col-xs-2">
                  ...
                  <div class="col-xs-2">
                      ...
                      <a href="{{ url('/admin/sale_advisors/itemreport') }}" class="btn btn-primary"><span class="glyphicon glyphicon-remove" aria-hidden="true"></span></a>
                  </div>
                </div>
                {!! Form::close() !!}
              </div>
