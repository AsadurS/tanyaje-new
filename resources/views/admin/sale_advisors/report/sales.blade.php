        ...
        <div class="box">
          <div class="box-header">
            ...
            <div class="container-fluid">
                <div class="row">
                <div class="col-xs-12">
                    {!! Form::open(array('url' =>'admin/sale_advisors/filtersalesreport', 'method'=>'get', 'class' => 'form-horizontal form-validate ', 'enctype'=>'multipart/form-data')) !!}
                                      ...
                                      @foreach($result['organisation'] as $organisations)
                                        @if (count($result['org_list']) > 0)
                                          @foreach($result['org_list'] as $org_lists)
                                            ...
                                            <option value="{{ $organisations->id }}">{{ $organisations->first_name }} {{ $organisations->last_name }}</option>
                                            @endif
                                          @endforeach
                                        @endif
                                      @endforeach
          ...
          <div class="box-body">
            ...
            <div class="row">
              <div class="col-xs-12">
                <!-- search filter -->
                {!! Form::open(array('url' =>'admin/sale_advisors/filtersalesreport', 'method'=>'get', 'class' => 'search-filter form-horizontal', 'enctype'=>'multipart/form-data')) !!}
                    <div class="form-group row">
                      <div class="col-xs-1">
                          <input class="form-control" id="ID" name="ID" type="text" placeholder="ID" value="{{ request()->has('ID') ? request()->get('ID') : '' }}">
                      </div>
                      ...
                      <div class="col-xs-2">
                          ...
                          <a href="{{ url('/admin/sale_advisors/salesreport') }}" class="btn btn-primary"><span class="glyphicon glyphicon-remove" aria-hidden="true"></span></a>
                      </div>
                    </div>
                {!! Form::close() !!}
              </div>
