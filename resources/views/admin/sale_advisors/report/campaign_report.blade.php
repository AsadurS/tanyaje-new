...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1> {{ trans('labels.titleCampaignReport') }}</h1>
    <ol class="breadcrumb">
      <li><a href="{{ URL::to('admin/sale_advisors/dashboard/')}}"><i class="fa fa-dashboard"></i> {{ trans('labels.breadcrumb_dashboard') }}</a></li>
      <li class="active"><a href="{{ URL::to('admin/sale_advisors/campaignreport')}}">{{ trans('labels.CampaignDashboard') }}</a></li>
        ...
        <div class="box">
          <div class="box-header">
            ...
            <div class="container-fluid">
                <div class="row">
                  <div class="col-xs-12">
                    {!! Form::open(array('url' =>'admin/sale_advisors/filtercampaignfullreport', 'method'=>'get', 'class' => 'form-horizontal form-validate ', 'enctype'=>'multipart/form-data')) !!}
            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <tbody>
                      @if (count($result['top_campaigns']) > 0)
                        ...
                        <tr>
                          ...
                          <!-- <td>{{ $top_campaign->company_name }}</td>
                          <td>{{ $top_campaign->merchant_name }}</td> -->
                  ...
                  <div class="col-xs-12 text-right">
                    {{-- {{$result['top_campaigns']->links()}} --}}
                    {!! $result['top_campaigns']->appends(request()->except('page'))->render() !!}
                  </div>
                 @endif
                </div>
            </div>
