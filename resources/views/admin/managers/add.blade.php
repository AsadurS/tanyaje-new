...
<div class="content-wrapper"> 
  ...
  <section class="content-header">
    <h1> {{ trans('labels.addmanagers') }} <small>{{ trans('labels.addmanagers') }}...</small> </h1>
    <ol class="breadcrumb">
      <li><a href="{{ URL::to('admin/dashboard/this_month')}}"><i class="fa fa-dashboard"></i> {{ trans('labels.breadcrumb_dashboard') }}</a></li>
      <li><a href="{{ URL::to('admin/managers')}}"><i class="fa fa-users"></i> {{ trans('labels.managers') }}</a></li>
      <li class="active">{{ trans('labels.addmanagers') }}</li>
    </ol>
  </section>
      ...
      <div class="col-md-12">
        <div class="box">
          <div class="box-header">
            <h3 class="box-title">{{ trans('labels.addmanagers') }} </h3>
          </div>
            ...
            <div class="row">
              <div class="col-xs-12">
              		<div class="box box-info">
                        ...
                        <!-- form start -->                        
                         <div class="box-body">
                            {!! Form::open(array('url' =>'admin/addnewmanager', 'method'=>'post', 'class' => 'form-horizontal form-validate', 'enctype'=>'multipart/form-data')) !!}
                            ...
                            <hr>
                            <!--h4>{{ trans('labels.Manager Personal Info') }} </h4>
                            <hr>
                                <div class="form-group">
                                  <label for="name" class="col-sm-2 col-md-3 control-label">{{ trans('labels.ManagerName') }} </label>
                                  <div class="col-sm-10 col-md-4">
                                    {!! Form::text('manager_name',  '', array('class'=>'form-control field-validate', 'id'=>'manager_name')) !!}
                                    <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">{{ trans('labels.ManagerNameText') }}</span>
                                    <span class="help-block hidden">{{ trans('labels.textRequiredFieldMessage') }}</span>
                                  </div>
                                </div>
                                <div class="form-group">
                                  <label for="name" class="col-sm-2 col-md-3 control-label">{{ trans('labels.ManagerContactNumber') }} </label>
                                  <div class="col-sm-10 col-md-4">
                                    {!! Form::text('manager_phone_no',  '', array('class'=>'form-control field-validate', 'id'=>'manager_phone_no')) !!}
                                    <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">{{ trans('labels.ManagerContactNumberText') }}</span>
                                    <span class="help-block hidden">{{ trans('labels.textRequiredFieldMessage') }}</span>
                                  </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10 col-md-4">
                                        <select name="state_id" class='form-control field-validate'>
