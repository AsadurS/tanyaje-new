...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Tanyaje - @foreach($data['sale_advisor'] as $sa){{$sa->merchant_name}}@endforeach - Extra Brochure</title>
            ...
            <div class="frameOuter container">
                <div class="row align-items-center">
                    ...
                    <div class="frame col-md-auto">
                        ...
                        <div id="app" class="{{  $data['sale_advisor'][0]->landingpage_version == 1 ? "lite" : "full" }} page-askme page-askme-extra-brochure"  v-cloak>
                            <sales-header
                                ...
                                :breadcrumb="{title:'Extra Brochure', link: '{{url($data['sa_base_url'])}}/ask'}"
                                :sadata="{{ $data['sale_advisor'][0] }}"
                                orglogo="{{$data['organisation']->logo}}"
                            ></sales-header>
                            <sales-ask-extra-brochure
                                :doctype="'Extra Brochure'"
                                :askme="{{ $data['askme'] }}"
                            ></sales-ask-extra-brochure>
                            <sales-customfooter
                                :template="{{ $data['template'] }}"
