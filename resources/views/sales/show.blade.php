            ...
            <div class="frameOuter container">
                <div class="row align-items-center">
                    ...
                    <div class="frame col-md-auto">
                        ...
                        <div id="app" class="{{  $data['sale_advisor'][0]->landingpage_version == 1 ? "lite" : "full" }} page-showme"  v-cloak>
                            <sales-header
                                ...
                                :breadcrumb="{title:'360&deg; Showcase', link: '{{url($data['sa_base_url'])}}'}"
                            ...
                            <sales-show-item-list
                                ...
                                :itemlist="{{ json_encode($data['itemlist']) }}"
                            ></sales-show-item-list>
                            <sales-customfooter
                                :template="{{ $data['template'] }}"
                                :sadata="{{ $data['sale_advisor'][0] }}"
