...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Tanyaje - @foreach($data['sale_advisor'] as $sa){{$sa->merchant_name}}@endforeach - Extra Pricelist</title>
            ...
            <div class="frameOuter container">
                <div class="row align-items-center">
                    ...
                    <div class="frame col-md-auto">
                        ...
                        <div id="app" class="{{  $data['sale_advisor'][0]->landingpage_version == 1 ? "lite" : "full" }} page-askme page-askme-extra-pricelist"  v-cloak>
                            <sales-header
                                ...
                                :breadcrumb="{title:'Extra Pricelist', link: '{{url($data['sa_base_url'])}}/ask'}"
                                :sadata="{{ $data['sale_advisor'][0] }}"
                                orglogo="{{$data['organisation']->logo}}"
                            ></sales-header>
                            <sales-ask-extra-pricelist
                                :doctype="'Extra Pricelist'"
                                :askme="{{ $data['askme'] }}"
                            ></sales-ask-extra-pricelist>
                            <sales-customfooter
                                :template="{{ $data['template'] }}"
