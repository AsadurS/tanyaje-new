            ...
            <div class="frameOuter container">
                <div class="row align-items-center">
                    ...
                    <div class="frame col-md-auto">
                        ...
                        <div id="app" class="{{  $data['sale_advisor'][0]->landingpage_version == 1 ? "lite" : "full" }} page-showme-model"  v-cloak>
                            <sales-header
                                ...
                                :breadcrumb="{title:'{{ $data['template'][0]->a360_title }}', link: '{{url($data['sa_base_url'])}}'}"
                            ...
                            <sales-show-models
                                ...
                                :makeId="'{{ $data['make_id'] }}'"
                                :modellist="{{ json_encode($data['model']) }}"
