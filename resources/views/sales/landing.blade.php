...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Tanyaje - @foreach($data['sale_advisor'] as $sa){{$sa->merchant_name}}@endforeach</title>
    ...
    <body class="webapp" style="background-image:url('{{ asset('new/images/sales/bg.jpg') }}')">
            ...
            <div class="frameOuter container">
                <div class="row align-items-center">
                    ...
                    <div class="frame col-md-auto">
                        ...
                        @if ($data['sale_advisor'][0]->verified !== 0) 
                        @include('sales.common.stickyhelp', [ 'openSticky' => false ])
                        @endif
                        <div id="app" class="{{  $data['sale_advisor'][0]->landingpage_version == 1 ? "lite" : "full" }} page-landing"  v-cloak>
                            <sales-header
                            ...
                            ></sales-customfooter>
                            @endif
                            @if ($data['sale_advisor'][0]->landingpage_version == 1)
                            <img src="{{asset('new/images/sales/lite-footer.png')}}" style="padding-left:10px; margin-bottom:30px; max-width: 100%;" class="lite-banner">
                            @endif
                        </div>
                    </div>
                </div>
        ...
        @include('sales.common.scripts', [ 'openSticky' => false ])
    </body>
</html>
