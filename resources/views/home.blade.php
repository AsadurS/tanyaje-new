...
<style>
    ...
    *************/
    ...
    .insurance-button.btn-secondary:hover,
    .insurance-button.btn-secondary:visited
    .insurance-button.btn-secondary:focus
    .insurance-button.btn-secondary:active
    {
        color: #fff;
...
?>
asd
<div class="hero home-slide" id="home_content">
    <!--div style="padding-bottom: 20px;">
        <div class="row">
            <div class="col-9"></div>
            <div class="col-3">
                <a class="button-sell-ad" href="{{route('car_quotation')}}">Sell my car</a>
            </div>
        </div>
    </div-->
    <!--div class="hero-caption">
        <p style="color: black;text-align: justify;width:67%">
            Lorem Ipsum is simply dummy text of the printing and typesetting industry.
            Lorem Ipsum has been the industry's standard dummy text ever since the 1500s,
            when an unknown printer took a galley of type and scrambled it to make a type specimen book.
        </p>
        <a class="btn btn-default btn-lg home-button"  style="font-weight: bold;font-size: small;" href="{{route('car_quotation')}}">Get Car Quote</a>
        <a class="btn btn-default btn-lg home-button" style="font-weight: bold;font-size: small;" href="{{route('insurance_quotation')}}">Get Insurance Quote</a>
    </div-->
    <div>
        <div class="row">
...
<div class="featured-slider-wrap car-list" style="padding-top:50px;padding-bottom:20px;">
    <div class="padding-container">
        <div class="row">
            <div class="col-12">
                <div class="row">
...
<div class="info-text-wrap" style="padding: 0px 0px 35px 0px !important;">
    <div class="padding-container">
        <div class="row align-items-center">
            <div class="col-md-4">
                <img src="{{asset('images/image3.jpg')}}" class="img-fluid mt-45 mt-20-xs mb-40-xs" alt="figure" >
            </div>
            <div class="col-md-4">
                <img src="{{asset('images/image4.jpg')}}" class="img-fluid" alt="figure" style="margin:50px 0px 20px -15px;">
            </div>
            <div class="col-md-4">
                <div class="title" style="text-transform:capitalize !important;">What's Tanyeje</div>
                <p style="text-align: justify;">
                    Tanya-Je translated as “Just Ask” is the first most advanced online digital automotive classified in South East Asia. In today’s highly competitive environment, our platform will offer dealers and sellers a 360° exterior and interior capturing mechanism that literally brings the vehicles to “Live”. Shoppers will fall in love with this experience as it allows them to explore every aspects of the vehicles from any angles.
                </p>
                <p style="text-align: justify;">
                    We are here to redefined how a vehicle is presented and viewed online.At Tanya-Je, we will continue to work and create leading technology  and advertising solutions that drive our business to new levels as we plan to be the leader in online automotive classified in South East Asia.
                </p>
            </div>
        </div>
    </div>
            ...
            <div class="col-12 text-center">
                <div class="row">
                    <div class="col-sm-6 col-md-6 col-lg-2 offset-md-4" style="float: right;margin: auto;">
                        <button class="btn btn-secondary start_button" href="home_content" style="border-radius:8px;background:black;font-size: 13px">Get Started ></button>
...
<div class="section-get-car-insurance">
    <div>
        <center>
            <a href="{{route('insurance_quotation')}}">
                <button class="btn btn-secondary start_button insurance-button">
                    I want to get quotation for my car insurance >>
                </button>
            </a>
        </center>
    </div>
