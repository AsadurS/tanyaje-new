        ...
        <div class="profile-inner">
            <div class="profile-left">
                ...
                <ul>
                    ...
                    <li ><a href="{!! route('promotions') !!}">Latest Promotions</a></li>
                    <li class="active"><a href="{!! route('myrewards') !!}">My Promotions</a></li>
                </ul>
            ...
            <div class="profile-right promo">
                <div class="main-infos">
                    ...
                    <div class="row">
                        ...
                        <a href="#" data-toggle="modal" data-target="#promoPop{{ $customerData->id  }}">
                        ...
                        <div class="modal fade " id="promoPop{{ $customerData->id  }}">
                            <div class="modal-dialog modal-lg">
                                ...
                                <label>Date Redeemed:</label>
                                                <p class="date"> {{ Carbon\Carbon::parse($customerData->redeem_date)->format('Y-m-d') }}
                             </p>
                                                 
                                                            <button type="submit" class="btn btn-primary claim-button">{{ $customerData->serial_prefix }}</button>
