               ...
               <tr>
                  <td align="center" bgcolor="#ffffff">
                     <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
                        ...
                        <!-- title -->
                        <tr>
                           <td align="center" style="font-size:36px; color:#3b3b3b; font-weight: 900;">Reset Your Password</td>
                        </tr>
                        <!-- end title -->
                        <tr>
                           <td align="center">
                        ...
                        <!-- content -->
                        <tr>
                           <td align="center" style="font-family: 'Open Sans', Arial, sans-serif; font-size:14px; color:#7f8c8d; line-height:29px;">Go to the link and change your password</td>
                        </tr>
                        <!-- end content -->
                        <tr>
                           <td height="10"></td>
                        ...
                        <tr>
                           <td align="center">
                              <table class="textbutton" align="center" border="0" cellspacing="0" cellpadding="0">
                                 <tr>
                                    <td class="btn-link" bgcolor="#f76d37" height="55" align="center" style="font-size:16px; color:#FFFFFF;font-weight: bold;padding-left: 25px;padding-right: 25px;border-radius:10px;font-weight:900"><a href="{{$reset_password_link}}" style="color:#fff;text-decoration:none">RESET PASSWORD</a></td>
                                 </tr>
                              </table>
                           </td>
                        </tr>
