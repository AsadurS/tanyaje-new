...
<html xmlns="http://www.w3.org/1999/xhtml">
   ...
   <body class="body">
      <table class="full" width="100%" border="0" align="center" cellpadding="0" cellspacing="0" background="{!! asset('/images/new/forgot-bg.jpg') !!}" valign="top" style="background-size: cover; background-position: center;">
         <tr>
            <td>
               <table class="table-inner" align="center" width="600" style="max-width: 600px;" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                     <td bgcolor="#FFFFFF" style="border-top-left-radius: 30px;border-top-right-radius: 30px;" align="center">
                        <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
                           ...
                           <!-- logo -->
                           <tr>
                              <td align="center" style="line-height: 0px;font-size: 25px;font-weight: bold;"><img src="https://www.tanyaje.com.my/new/images/logo.png" alt="logo" style="width:200px"></td>
                           </tr>
                           <!-- end logo -->
                           <tr>
                              <td height="30"></td>
                  ...
                  <tr>
                     <td align="center" bgcolor="#ffffff">
                        <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
                           ...
                           <!-- title -->
                           <tr>
                              <td align="center" style="font-family: 'Open Sans', Arial, sans-serif; font-size:36px; color:#3b3b3b; font-weight: bold;">Successful Register</td>
                           </tr>
                           <!-- end title -->
                           <tr>
                              <td align="center">
                           ...
                           <!-- content -->
                           <tr>
                              <td align="center" style="font-family: 'Open Sans', Arial, sans-serif; font-size:14px; color:#7f8c8d; line-height:29px;">Now you can go to <a href="{{ $loginPage }}">login page</a> to login.</td>
                           </tr>
                           <!-- end content -->
                           <tr>
                              <td height="10"></td>
                           ...
                           <tr>
                              <td align="center">
                                 <table class="textbutton" align="center" border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                       <td class="btn-link" bgcolor="#f76d37" height="55" align="center" style="font-family: 'Open Sans', Arial, sans-serif; font-size:16px; color:#FFFFFF;font-weight: bold;padding-left: 25px;padding-right: 25px;border-radius:10px;"><a href="{{$loginPage}}" style="color:#fff;text-decoration:none">LOG IN</a></td>
                                    </tr>
                                 </table>
                              </td>
                           </tr>
                  ...
                  <tr>
                     <td style="color:#fff;text-align:center">© Tanyaje Copyrights Reserved 2020</td>
                  </tr>
                  <tr>
                     <td height="30"></td>
                  </tr>
