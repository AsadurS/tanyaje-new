...
@section('meta_for_share')
    <meta property="og:title" content="{{ trans('labels.app_name') }} | Insurance Quotation">
...
@endsection
@section('content')
<div class="hero" style="background: url(../images/insurance_quotation_banner.jpg) no-repeat scroll top;background-size: cover;">
            ...
            <div class="col-12 text-center">
                <div class="row">
                    <div class="col-sm-6 col-md-6 col-lg-2 offset-md-4" style="float: right;margin: auto;">
                        <button class="btn btn-secondary start_button" href="insurance_form" style="border-radius:8px;background:black;font-size: 13px">Get Started ></button>
...
<div class="featured-slider-wrap" id="insurance_form" style="padding: 41px 0px 90px !important;">
    <div class="container">
            ...
            <div class="col-8">
                <form>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <input type="text" name="car_ic" class="form-control" placeholder="IC">
                        </div>
                        <div class="col-md-4">
                            <input type="text" name="car_plate" class="form-control" placeholder="Car Plate">
                        </div>
                        <div class="col-md-2">
                        </div>
                    </div>
...
<script>
    ...
    $(".btn-submit").click(function(e){
        ...
        var car_ic = $("input[name='car_ic']").val();
        var car_plate = $("input[name='car_plate']").val();


        $.ajax({
            url: "/insurancequotation",
            type:'POST',
            data: {_token:_token, name:name, contact:contact, email:email, car_ic:car_ic, car_plate:car_plate},
            success: function(data) {
                if($.isEmptyObject(data.error)){
                    $("input[name='name']").val('');
                    $("input[name='contact']").val('');
                    $("input[name='email']").val('');
                    $("input[name='car_ic']").val('');
                    $("input[name='car_plate']").val('');
